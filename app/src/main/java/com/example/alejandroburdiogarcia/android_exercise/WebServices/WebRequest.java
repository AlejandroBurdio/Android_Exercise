package com.example.alejandroburdiogarcia.android_exercise.WebServices;

/**
 * Created by Alejandro Burdío on 10/05/2016.
 */
...
public class WebRequest {
    ...
    public final static int GETRequest = 0;
    public final static int POSTRequest = 1;
    ...
    public String makeWebServiceCall(String urladdress, int requestmethod, HashMap<String, String> params) {
        ...
        try {
            ...
            conn.setReadTimeout(30001);//15001
            conn.setConnectTimeout(30001);//15001
